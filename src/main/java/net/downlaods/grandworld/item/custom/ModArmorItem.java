package net.downlaods.grandworld.item.custom;

import com.google.common.collect.ImmutableMap;
import net.downlaods.grandworld.effect.ModEffects;
import net.downlaods.grandworld.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.IMPERITE_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(ModEffects.ENERGISED, 100, 0, true, false))).build();
